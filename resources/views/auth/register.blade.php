            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                    <div class="card card-signup">
                        <form class="form" id="form-register" method="POST" action="{{route('register') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="footer text-center">
                                <button id="register" type="submit" class="btn btn-simple btn-info btn-lg">Get Started</button>
                            </div>
                        </form>
                    </div>
                </div>
